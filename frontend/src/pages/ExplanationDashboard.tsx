  ...
  const handleAdapt = async (adaptationType: 'simpler' | 'analogy' | 'deeper') => {
    ...
    try {
      const response = await fetch('http://localhost:8000/adapt', {
        ...
        body: JSON.stringify({
          current_explanation: explanation.explanation,
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button
                  ...
                  disabled={isLoading}
                  className="bg-green-600 hover:bg-green-700 disabled:bg-gray-300 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="bg-yellow-600 hover:bg-yellow-700 disabled:bg-gray-300 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg disabled:cursor-not-allowed"
                >
                  <div className="text-2xl mb-2">💡</div>
                  Give Analogy
                </button>
                <button
                  ...
                  disabled={isLoading}
                  className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg disabled:cursor-not-allowed"
                >
                  <div className="text-2xl mb-2">📈</div>
                  Go Deeper
                </button>
